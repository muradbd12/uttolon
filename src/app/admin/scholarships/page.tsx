...
export const metadata: Metadata = {
  title: "বৃত্তি আবেদন | Admin | Uttolon",
    ...
    <RequireRoleAuth role="admin" loginPath="/admin/login">
      <section className="bg-paper-raised">
        <div className="mx-auto max-w-3xl px-5 py-10 sm:px-8">
          ...
          <h1 className="mt-4 font-display-bn text-2xl text-ink sm:text-3xl">বৃত্তি আবেদন</h1>
          <p className="mt-2 text-sm text-ink-soft">জমা হওয়া সব আবেদন — অনুমোদন বা প্রত্যাখ্যান করুন।</p>
          <div className="mt-8">
            <AdminScholarshipsList />
          </div>
        </div>
      </section>
    </RequireRoleAuth>
