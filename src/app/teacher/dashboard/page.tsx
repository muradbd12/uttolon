      ...
      <div className="mx-auto max-w-6xl px-5 py-10 sm:px-8">
        ...
        <div className="flex items-start gap-3 rounded-sm border border-gold/30 bg-gold-soft/40 p-4">
          ...
          <p className="text-sm leading-relaxed text-ink">
            এটি Teacher Dashboard-এর একটি <span className="font-medium">ডিজাইন প্রিভিউ</span> —
            নিচের সব তথ্য নমুনা (demo) ডেটা, কোনো বাস্তব শিক্ষক বা শিক্ষার্থীর তথ্য নয়।
            লগইন সিস্টেম ও আসল ডেটাবেস যুক্ত হওয়ার পরই এই পাতাটি নিরাপত্তার সাথে
        ...
        <div className="mt-8 flex flex-wrap items-center justify-between gap-4 border-b border-line pb-6">
          <div>
            ...
            <h1 className="mt-2 font-display-bn text-2xl text-ink sm:text-3xl">
              স্বাগতম, {demoTeacher.name}
            </h1>
            <p className="mt-1 text-sm text-ink-soft">
              {demoTeacher.subject} · {demoTeacher.institution}
            </p>
          </div>
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <div className="rounded-sm border border-line bg-paper p-6">
              ...
              <button
                type="button"
                disabled
                className="mt-4 flex cursor-not-allowed items-center gap-1.5 rounded-sm border border-line px-4 py-2 text-sm text-ink-soft/50"
              >
                <CheckSquare size={14} /> উপস্থিতি নিন (শীঘ্রই)
              </button>
            </div>
